...
class BetaTokenConfig:
    ...
    ADMIN_SECRET = os.environ.get('VALID8_ADMIN_SECRET', 'dev-secret-change-in-production')
    
    # Token storage
    TOKEN_FILE = Path.home() / '.valid8' / 'beta_tokens.json'
    INSTALLATIONS_FILE = Path.home() / '.valid8' / 'beta_installations.json'
